  ...
  return(
    ...
    <nav className="flex w-full bg-slate-500 justify-between h-20">
      ...
      <div className="flex items-center">
        <a href="" className="py-0 px-2 mx-1 text-white text-xl font-medium">List Pokemon</a>
        <a href="" className="p-3 px-2 mx-1 text-white text-xl font-medium">My Pokemon</a>
      </div>
    </nav>
    </>
  )
